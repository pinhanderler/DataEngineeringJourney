...
1. [GET Request Nedir?](#get-nedir)
2. [TestBase Sınıfı](#testbase)
...
public class GetRequest07 extends TestBase {
    ...
    // ❌ Kötü Yol: Parametreleri URL'ye doğrudan yaz
    @Test
    public void get01() {
        Response response = given()
                                .spec(spec01)
...
*📌 Sonraki ders: JsonPath, SoftAssert, GSON De-Serialization*
