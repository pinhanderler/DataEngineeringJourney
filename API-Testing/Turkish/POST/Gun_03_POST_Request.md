# 🌐 Gün 3 — POST Request (4 Farklı Yol)
...
1. [POST Request Nedir?](#post-nedir)
2. [GET vs POST Farkları](#get-vs-post)
3. [PostRequest01 — String Body](#postrequest01)
4. [PostRequest02 — JSONObject Sınıfı](#postrequest02)
5. [PostRequest03 — HashMap](#postrequest03)
6. [PostRequest04 — POJO (En İyi Yol)](#postrequest04)
7. [PostRequest05 — POJO + Getter ile Verify](#postrequest05)
8. [Alıştırmalar](#alıştırmalar)

---

## 🔷 POST Request Nedir? {#post-nedir}

POST Request, API'ya **yeni veri oluşturmak** için kullanılır.

### POST Request için Gerekenler:

| # | Gereksinim | Zorunlu mu? |
|---|-----------|-------------|
| 1 | Endpoint | ✅ Şart |
| 2 | Request Body | ✅ Şart |
| 3 | Authorization | ✅ Şart |
| 4 | Accept Type | ⚡ İsteğe bağlı |
| 5 | Content Type | ⚡ İsteğe bağlı |
...
## 🆚 GET vs POST Farkları {#get-vs-post}

| Özellik | GET | POST |
|---------|-----|------|
| Amaç | Veri okuma | Yeni veri oluşturma |
| Request Body | ❌ Gerekmez | ✅ Zorunlu |
| Authorization | İsteğe bağlı | Genellikle zorunlu |
| Idempotent | ✅ Evet | ❌ Hayır |

---

## 📋 PostRequest01 — String Body (Kötü Yol) {#postrequest01}
...
## 📋 PostRequest02 — JSONObject Sınıfı {#postrequest02}
...
## 📋 PostRequest03 — HashMap ile {#postrequest03}
...
## 📋 PostRequest04 — POJO (En İyi Yol!) {#postrequest04}
...
## 📋 PostRequest05 — POJO + Getter ile Verify {#postrequest05}
...
## 📊 4 Yol Karşılaştırması

| Yol | Avantaj | Dezavantaj |
|-----|---------|------------|
| String body | Basit | ❌ Bakımı zor, hata yapımı kolay |
...
*📌 Sonraki ders: PUT, PATCH, DELETE Request'ler*
