# 🌐 Gün 4 — PUT, PATCH & DELETE Request
...
2. [PutRequest01 — Temel PUT](#putrequest01)
3. [PutRequest02 — Verify ile PUT](#putrequest02)
...
## 📋 PutRequest01 — Temel PUT {#putrequest01}
...
## 📋 PutRequest02 — Verify ile PUT {#putrequest02}
...
## 📋 PatchRequest01 — Kısmi Güncelleme {#patchrequest01}
...
*📌 Sonraki ders: POJO oluşturma, pom.xml bağımlılıkları*
